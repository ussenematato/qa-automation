...
Network.EVENT_CONFIGS = {
    ...
    "before_request_sent": EventConfig(
        ...
        _globals.get("BeforeRequestSent", dict) if _globals.get("BeforeRequestSent") else dict,
    ),
    "fetch_error": EventConfig(
        "fetch_error",
        "network.fetchError",
        _globals.get("FetchError", dict) if _globals.get("FetchError") else dict,
    ),
    "response_completed": EventConfig(
        "response_completed",
        "network.responseCompleted",
        _globals.get("ResponseCompleted", dict) if _globals.get("ResponseCompleted") else dict,
    ),
    "response_started": EventConfig(
        "response_started",
        "network.responseStarted",
        _globals.get("ResponseStarted", dict) if _globals.get("ResponseStarted") else dict,
    ),
