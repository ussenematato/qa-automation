...
class NetworkConditions:
    ...
    def from_json(cls, json):
        return cls(
            ...
            offline=bool(json['offline']) if 'offline' in json else None,
        )
...
def emulate_network_conditions_by_rule(
        ...
        matched_network_conditions: typing.List[NetworkConditions] = None
    ...
    **EXPERIMENTAL**
    ...
    :param offline: *(Optional)* True to emulate internet disconnection. Deprecated, use the offline property in matchedNetworkConditions or emulateOfflineServiceWorker instead.
