...
class ConnectionAllowlistError(enum.Enum):
    ...
    I_FRAME_ATTRIBUTE_LOOSENS_EMBEDDING_REQUIREMENT = "IFrameAttributeLoosensEmbeddingRequirement"
    INVALID_ALLOW_CONNECTION_ALLOWLIST_FROM = "InvalidAllowConnectionAllowlistFrom"
    EMBEDDING_REQUIREMENT_NOT_SATISFIED = "EmbeddingRequirementNotSatisfied"
...
class InspectorIssueDetails:
    ...
    def from_json(cls, json):
        return cls(
            ...
            email_verification_request_issue_details=EmailVerificationRequestIssueDetails.from_json(json['emailVerificationRequestIssueDetails']) if 'emailVerificationRequestIssueDetails' in json else None,
            lazy_load_image_issue_details=LazyLoadImageIssueDetails.from_json(json['lazyLoadImageIssueDetails']) if 'lazyLoadImageIssueDetails' in json else None,
        )
