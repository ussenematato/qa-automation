...
class VirtualAuthenticatorOptions:
    ...
    def from_json(cls, json):
        return cls(
            ...
            has_hmac_secret=bool(json['hasHmacSecret']) if 'hasHmacSecret' in json else None,
            has_hmac_secret_mc=bool(json['hasHmacSecretMc']) if 'hasHmacSecretMc' in json else None,
            has_cmtg_key=bool(json['hasCmtgKey']) if 'hasCmtgKey' in json else None,
...
class Credential:
    ...
    def from_json(cls, json):
        return cls(
            ...
            cmtg_keys=[str(i) for i in json['cmtgKeys']] if 'cmtgKeys' in json else None,
            active_cmtg_key_index=int(json['activeCmtgKeyIndex']) if 'activeCmtgKeyIndex' in json else None,
            generate_cmtg_key_on_next_operation=bool(json['generateCmtgKeyOnNextOperation']) if 'generateCmtgKeyOnNextOperation' in json else None,
        )
